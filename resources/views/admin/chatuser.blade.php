                           ...
                           <div class="header">
                            @for ($i = 0; $i < count($f); $i++)
                             <div class="containner darker">
                              ...
                              @if ( $f[$i][0]->readed==0 && $f[$i][0]->check_admin_send==0)
                              <strong class="primary-font">
                                <a href="/admin/messages/{{$f[$i][0]->user_id}}"><p>{{$f[$i][0]->user->name}}<span class="badge badge-light">un read</span></p> </a>
                             </strong>
                              
                              @else
                              <strong class="primary-font">
                                <a href="/admin/messages/{{$f[$i][0]->user_id}}"><p>{{$f[$i][0]->user->name}}</p> </a>
                             </strong>
